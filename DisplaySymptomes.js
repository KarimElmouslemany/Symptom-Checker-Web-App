...
async function display_letters(data, adding_to_main_page) {
  // adding letters to main page
  for (const letter of letters) {
    const letter_heading = document.createElement("h2");
    const letter_container = document.createElement("div");
    letter_container.className =
...
async function display_symptoms(
  data,
  adding_to_main_page,
  letter_adding_to_container,
) {
  // adding symptoms to main page
